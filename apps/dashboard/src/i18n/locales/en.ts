export default {
  ...
  infrastructure: {
    ...
    confirmRemoveServer:
      'Are you sure you want to remove this server? All associated apps and domains will be deleted.',
    ...
    waitingForLogs:
      'Waiting for installation logs... Click "Load Server Logs" to fetch stored logs.',
    comingSoon: 'Coming Soon',
    installed: 'Installed',
    ...
    connectionStringWarning:
      'This connection string is shown only once. Make sure to save it securely!',
    ...
    updateFailedHint:
      'You can try updating manually via SSH or check the server logs for more details.',
    ...
    agentOfflineWarning:
      'Agent is offline. The server will be removed from the dashboard, but the agent may continue running on the server.',
    ...
    removeRuntimeWarning:
      'This will completely remove {runtime} from the server. This action cannot be undone.',
    removeDatabaseTitle: 'Remove {db}?',
    removeDatabaseWarning:
      'This will completely remove {db} and all its data from the server. This action cannot be undone.',
    reconfigureDbTitle: 'Reconfigure {db}',
    reconfigureDbDesc:
      'This will create a new database and user with a new password. The old database will remain unchanged.',
    ...
    startingDb: 'Starting {db}',
    stoppingDb: 'Stopping {db}',
  ...
  settings: {
    ...
    downloadDataDesc:
      'Get a copy of all your personal data we hold (Article 20 - Right to data portability)',
  ...
  billing: {
    ...
    approachingLimits:
      "You're approaching your plan limits. Upgrade now to unlock more capacity and premium features.",
  ...
  support: {
    ...
    descriptionPlaceholder:
      'Please describe your issue in detail. Include any relevant information that might help us assist you faster...',
    category: 'Category',
    priority: 'Priority',
    status: 'Status',
    created: 'Created',
  ...
  mcp: {
    title: 'MCP Bridge',
    subtitle:
      'Connect AI assistants (Claude, Cursor) to control your infrastructure via natural language.',
  ...
  admin: {
    ...
    security: {
      ...
      rotateCPWarning:
        'Warning: Rotating the CP key will require all connected agents to update their stored key.',
  ...
  onboarding: {
    ...
    gdpr: '(GDPR)',
    waiveWithdrawal:
      'I expressly request immediate access to the service and acknowledge that I waive my 14-day withdrawal right once the service is activated',
    saving: 'Saving...',
  ...
  errors: {
    ...
    serverLimitMessage:
      'You have reached your server limit ({current}/{limit}). Please upgrade your plan to add more.',
    appLimitReached: 'App Limit Reached',
    appLimitMessage:
      'You have reached your app limit ({current}/{limit}). Please upgrade your plan to add more.',
    domainLimitReached: 'Domain Limit Reached',
    domainLimitMessage:
      'You have reached your domain limit ({current}/{limit}). Please upgrade your plan to add more.',
  ...
  security: {
    ...
    ed25519Description:
      'All communication between your servers and the control plane is secured using Ed25519 cryptographic signatures. The fingerprints shown are SHA256 hashes of the public keys for easy verification.',
  ...
  mail: {
    wizard: {
      ...
      cta: {
        ...
        description:
          'The guided wizard automatically configures Postfix, Dovecot, DKIM, SPF and antispam in a few clicks.',
        button: 'Launch wizard',
        recommended: 'Recommended',
        collapsed: 'Mail configuration wizard',
      ...
      architecture: {
        ...
        distributed: {
          ...
          description:
            'Services spread across multiple servers. Scalable and suited for enterprises.',
        },
        ha: {
          title: 'High Availability',
          description:
            'Cluster with replication and automatic failover. For critical environments.',
        },
      },
      servers: {
      ...
      dns: {
        ...
        important: 'Important',
        importantDesc:
          'These DNS records must be configured BEFORE your mail server can work properly.',
  ...
  dns: {
    wizard: {
      ...
      subtitle: 'BIND9 Configuration Wizard',
      recommended: 'Recommended',
      comingSoon: 'Coming Soon',
      reconfigure: 'Reconfigure',
      required: 'Required',
      requires2Servers: '2 servers required',
      cta: {
        title: 'Configure your DNS server',
        description:
          'The guided wizard automatically configures BIND9 with your DNS zones, DNSSEC, and security options in just a few clicks.',
        button: 'Launch wizard',
        recommended: 'Recommended',
        collapsed: 'DNS Configuration Wizard',
        clickExpand: 'Click to expand',
        collapse: 'Collapse',
      },
      architecture: {
        title: 'Choose your architecture',
        description: 'Select the DNS server type that fits your needs.',
        primary: {
          title: 'Primary Server',
          description:
            'Authoritative DNS server for your domains. Ideal for SMBs and small organizations.',
        },
        primarySecondary: {
          title: 'Primary + Secondary',
          description:
            'High availability with a backup server. For enterprises requiring redundancy.',
        },
        cache: {
          title: 'Cache / Recursive',
          description:
            'Speeds up DNS queries on your local network. Ideal for corporate networks.',
        },
        splitHorizon: {
          title: 'Split-Horizon',
          description:
            'Different responses based on query origin (internal/external). For MSPs and hosting providers.',
        },
      },
      config: {
        title: 'Server Configuration',
        description: 'Basic settings for your DNS server.',
        selectServer: 'DNS Server',
        secondaryServer: 'Secondary Server',
        choose: 'Choose a server...',
        hostname: 'DNS Hostname',
        hostnameHint: 'The full name of your server (e.g., ns1.example.com)',
        forwarders: 'Upstream DNS Servers',
        forwardersHint: 'Servers to query for recursive requests',
        localNetwork: 'Allowed Local Network',
        localNetworkHint: 'IP range allowed to use the cache (e.g., 192.168.1.0/24)',
        servicesInstalled: 'Services to be installed:',
      },
      zones: {
        title: 'DNS Zones',
        description: 'Configure the domains your server will manage.',
        ...
        slave: 'Slave',
        forward: 'Forward',
        reverseZone: 'Create reverse zone automatically',
        reverseZoneHint: 'Enables reverse resolution (IP → name)',
        cacheMode: 'Cache mode enabled',
        cacheModeDesc:
          'In cache mode, no zones are needed. The server will relay queries to the configured forwarders.',
      },
      security: {
        title: 'DNS Security',
        description: 'Security options to protect your DNS infrastructure.',
        dnssec: {
          title: 'DNSSEC',
          description: 'Cryptographic zone signing to prevent spoofing',
          algorithm: 'Algorithm',
          autoRotation: 'Automatic key rotation',
        },
        tsig: {
          title: 'TSIG',
          description: 'Secure authentication for zone transfers',
          autoGenerated: 'A TSIG key will be automatically generated to secure transfers between servers.',
        },
        rrl: {
          title: 'Rate Limiting (RRL)',
          description: 'Protection against DNS amplification DDoS attacks',
          responsesPerSec: 'Responses/sec',
          window: 'Window (sec)',
        },
        logging: {
          title: 'Query Logging',
          description: 'Log all DNS queries (for audit/debug)',
        },
      },
      records: {
        title: 'DNS Records',
        description: 'Preview the records that will be created.',
        important: 'Important',
        importantDesc:
          'These records will be created automatically. You will also need to update the NS records at your registrar.',
        copyAll: 'Copy All Records',
        cacheMode: 'Cache Mode',
        cacheModeDesc:
          'In cache mode, no DNS records are created. The server acts only as a relay.',
      },
      install: {
        title: 'Installation',
        description: 'Review the configuration and start the installation.',
        ...
        start: 'Start Installation',
        complete: 'Installation Complete!',
        completeDesc: 'Your DNS server is configured and operational.',
        reminder: "Don't forget:",
        reminderDesc:
          'Update the NS records at your registrar to point to this server.',
      },
    },
    manual: {
      title: 'Manual configuration',
    ...
    wizard: {
      ...
      advanced: {
        ...
        performance: {
          ...
          presetLabel: 'Performance profile',
          presetAuto: 'Automatic',
          presetLight: 'Light',
