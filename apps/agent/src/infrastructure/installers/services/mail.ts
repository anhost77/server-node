...
`;
    ...
    await runCommand('bash', ['-c', 'DEBIAN_FRONTEND=noninteractive apt-get install -y ' + postfixPackages.join(' ')], onLog);
    ...
    await runCommandSilent('postconf', ['-e', `mydestination=$myhostname, ${domain}, localhost.localdomain, localhost`]);
