...
document.addEventListener('DOMContentLoaded', () => {
  ...
  gsap.from('.hero-title .split-line', {
    y: 100,
    opacity: 0,
    stagger: 0.2,
    duration: 1,
    ...
    const runtimesData = [
      {
        id: 'JS',
        name: 'Node.js',
        icon: '/assets/runtime-nodejs.png',
        desc: 'npm, yarn, pnpm. Hot reload < 2s avec PM2.',
      },
      {
        id: 'PY',
        name: 'Python',
        icon: '/assets/runtime-python.png',
        desc: 'pip, venv, Uvicorn, Gunicorn. Django, Flask, FastAPI ready.',
      },
      {
        id: 'PHP',
        name: 'PHP',
        icon: '/assets/runtime-php.png',
        desc: 'PHP-FPM, Composer, extensions MySQL/PostgreSQL incluses.',
      },
      {
        id: 'GO',
        name: 'Go',
        icon: '/assets/runtime-go.png',
        desc: 'Go 1.22+, compilation ARM64/amd64 automatique.',
      },
      {
        id: 'RS',
        name: 'Rust',
        icon: '/assets/runtime-rust.png',
        desc: 'Cargo, rustup, toolchain stable. Compilation optimisée.',
      },
      {
        id: 'RB',
        name: 'Ruby',
        icon: '/assets/runtime-ruby.png',
        desc: 'Bundler, Puma, Rails-ready. Gems pré-installés.',
      },
      {
        id: 'DK',
        name: 'Docker',
        icon: '/assets/runtime-docker.png',
        desc: 'docker-compose, Dockerfile. Conteneurs orchestrés.',
      },
    ];
